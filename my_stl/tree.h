...
template<class _K, class _Ty, class _Kfn, class _Pr, class _A=myallocator<_Ty>()>
class _Tree {
 public:
 ...
 protected:
  ...
  void _Consval(pointer _P, const _Ty &_V) { allocator.construct(&*_P, _V); }
  void _Destval(pointer _P) { allocator.destroy(&*_P); }
